...
abstract public class OntologyMultiplexor extends Multiplexor
{
	...
	public void initialize()
    {
         ...
         */
        Reasoner reasoner = new GenericRuleReasoner(Rule.rulesFromURL("file:ontology/evalrule.rule"));
        OntModelSpec spec = new OntModelSpec( OntModelSpec.OWL_DL_MEM );
        spec.setReasoner(reasoner);
    	...
    	//read the files
    	//ontmodel.read("http://www.cs.rdg.ac.uk/webpageEval#");
    	ontmodel.read(in, "http://www.cs.rdg.ac.uk/webpageEval#","N3");
    	
    	OwlLang o = new OwlLang(ontmodel,"http://www.cs.rdg.ac.uk/webpageEval#");
    	o.setLabeledPrefix("eval","http://www.cs.rdg.ac.uk/webpageEval#");
    	
    	//spec.setReasoner(PelletReasonerFactory.theInstance().create());
    	    	    	
    	//Create the OwlLang parser 
    	owllang = new OwlLang(ontmodel,"http://www.cs.rdg.ac.uk/webpageEval#");
    	//owllang.setLabeledPrefix("eval","http://www.cs.rdg.ac.uk/webpageEval#");
