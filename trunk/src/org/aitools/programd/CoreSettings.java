...
public class CoreSettings extends Settings
{
    ...
    */
    protected void initialize()
    {
        ...
        setOntology(this.properties.getProperty("programd.multiplexor-ontology",null));
    ...
    /**
     * @return the value of ontologyDirectory
     */
	...
	/**
     * @param ontologyFileNameToSet   the value to which to set ontologyFileName
     */
    public void setOntology(String ontologyToSet)
    {
        this.ontology = ontologyToSet;
    }
