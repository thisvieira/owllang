...
public class AjaxServer
{
    ...
    /*
    private HashMap <String,String>secureMap = new HashMap<String,String>();
    
    public void setHashMap(String key, String val)
    {
    	secureMap.put(key,val);
    }
    
    public String getHashMap(String key)
    {
    	return secureMap.get(key);
    }
*/
    /**
     ...
     */
    public AjaxServer(String corePropertiesPath, String webServerPropertiesPath)
    {
     ...
     */
    public AjaxServer(String corePropertiesPath, String webServerPropertiesPath, String consolePropertiesPath)
    {
    ...
    public static void main(String[] argv)
    {
        ...
        {
            server = new AjaxServer(corePropertiesPath, webServerPropertiesPath);
        }
        else
        {
            server = new AjaxServer(corePropertiesPath, webServerPropertiesPath, consolePropertiesPath);
        }
