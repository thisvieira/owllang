        ...
        switch (action)
        {
            ...
            case authenticate:
                ...
                switch (authResult)
                {
                    ...
                    case authenticated:
                        String uid = getCookieValue(envelope.getServiceRequest(), USER_COOKIE_NAME);
                    	if(uid==null)
                    	{
                    		try
                    		{
                    			//envelope.getServiceResponse().getOutputStream().println();
                    			uid = getCookieValue(envelope.getServiceRequest(), USER_COOKIE_NAME);
                    		} catch (Exception e)
                    		{
                    			//TODO do something
                    		}
                        ...
                        return envelope.getCore().getResponse(envelope.getUserRequest(),
                                uid, envelope.getBotID(), new HTMLResponder(this, envelope));
